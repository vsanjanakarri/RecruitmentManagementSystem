...
<body>
	 <div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Company Reports</li>
			</ol>
		</section>
		<!-- Main content -->
		<section class="content">
			<div class="box box-info">
				...
				<form
					action="${pageContext.request.contextPath}/getCompanyDetailsReport"
					id="companyReportform" name="companyReportform"
					method="post">
					...
					<div class="form-group">
						<div class="col-sm-3">
							<label class="control-label">Company Name</label> <select
					...
					<button type="button" id="search" class="btn btn-block btn-primary" onclick="searchCompanyReport();" style="width: 80px;">Search</button>
					<br/><br/>
					<br/><br/>
	...
	<script type="text/javascript">
		...
		function applyJob() {
			document.companyReportform.action = "${pageContext.request.contextPath}/getCompanyDetailsReport?company_id="+ company_id +'&city_id=' + city_id +
				'&state_id=' + state_id;
			document.companyReportform.submit();
		}
		function searchCompanyReport(){
			var company_id=document.getElementById("company_id").value;
			var state_id=document.getElementById("state_id").value;
			var city_id=document.getElementById("city_id").value;
			$.get(
					'${pageContext.request.contextPath}/getCompanyReportbyCompany_name?company_id='+ company_id +'&city_id=' + city_id +
